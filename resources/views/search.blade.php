...
<div class="flex w-full ">
    <div class="container mx-auto bg-white mt-0 px-3 xl:px-10 py-5">
        @if(count($products) == 1)
        <div class="w-full text-center text-md lg:text-xl font-light space-x-1 my-5"> {{count($products)}} product found in search result of <strong class="font-bold"> {{$query['query']}}</strong>.</div>
        @elseif(count($products))
        <div class="w-full text-center text-md lg:text-xl font-light space-x-1 my-5"> {{count($products)}} products found in search result of <strong class="font-bold"> {{$query['query']}} </strong>. </div>
