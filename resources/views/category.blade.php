...
<div class="flex w-full ">
    <div class="container mx-auto bg-white mt-0 px-3 xl:px-10 py-5">
        <div class="w-full text-center text-md lg:text-xl font-light space-x-1 my-5"> Showing products from <strong class="font-bold text-orange"> {{$category->category_name}} </strong> category.</div>
