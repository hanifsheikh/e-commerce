...
<div class="hidden xl:flex flex-col bg-white shadow-md rounded-md rounded-b-none">
    <div class="flex ml-3 pt-3">
        <p class="relative flex h-7 items-start">
            ...
            <a href="/new-arrivals" class="text-dark font-bold text-sm uppercase">Latest Products</a>
    ...
    <div id="best-selling" class="best-selling owl-carousel overflow-hidden">
        ...
        <div class="grid grid-cols-3 gap-2 gap-y-8" style="padding:2rem 2rem;">
            @endif
            <!-- Single Product  -->
            <div class="grid grid-cols-4 space-x-3">
                ...
                <div class="flex col-span-3 flex-col space-y-2">
            ...
            <!-- Single Prduct Ends  -->
            <?php $group_counter++ ?>
            @if($group_counter % 6 ==0 || $group_counter == $products_count )
        </div>
        @endif
