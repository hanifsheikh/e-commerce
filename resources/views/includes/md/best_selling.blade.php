...
<div class="hidden md:flex lg:hidden flex-col bg-white shadow-md rounded-md rounded-b-none">
    ...
    <div id="best-selling" class="best-selling owl-carousel overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-2 gap-y-8" style="padding:2rem 2rem;">
            @endif
            <!-- Single Product  -->
            ...
            <?php $group_counter++ ?>
            @if($group_counter % 4 ==0 || $group_counter == $products_count )
        </div>
        @endif
