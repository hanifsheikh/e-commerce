...
class DashboardController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('HasPermission:dashboard-view')->only('fetchData');
        $this->middleware('HasPermission:cache-update')->only('refreshCache');
    }
    public function refreshCache()
    {
        ...
        return response()->json(['status' => true, 'message' => 'Cache updated successfully.']);
    }
    ...
    public function refreshProductCache()
    {
    ...
    public function refreshSellerCache()
    {
    ...
    public function refreshCategoryProductCache()
    {
    ...
    public function refreshDailyDealsCache()
    {
        $image = DB::table('product_images')
            ->select('product_variant_id', 'thumbnail AS image', 'position')
            ->orderBy('position')
    ...
    public function refreshBestSellingCache()
    {
        $image = DB::table('product_images')
            ->select('product_variant_id', 'thumbnail AS image', 'position')
            ->orderBy('position')
